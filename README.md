...
由于 EdgeKey 现有技术框架及 UI 组件体系的限制，已难以满足新版本对功能扩展、交互体验与界面一致性的要求。因此 CFFK 基于全新的技术栈重新设计与开发并且拥有 EdgeKey 的所有功能 ；因为底层框架不同，所有项目必须采用独立仓库维护，
CFFK 将持续完善功能、交互体验与整体架构。后续 EdgeKey 则会转为轻量化版本继续维护，专注于 Bug 修复与稳定性优化，但是不再进行大型功能迭代。

感谢 EdgeKey 社区提供的反馈、建议，以及每一位贡献者提交的 PR。

[CFFK VS EdgeKey 功能对比](https://github.com/34892002/cffk#-%E4%B8%8E-edgekey-%E7%9A%84%E5%AF%B9%E6%AF%94)

[CFFK 发卡项目](https://github.com/34892002/cffk)
